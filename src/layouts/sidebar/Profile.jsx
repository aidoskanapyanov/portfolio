...
export default function Profile() {
  return (
    <section className="pb-10 flex flex-col gap-y-6 items-center">
      ...
      <p className="text-xs md:text-sm font-thin tracking-widest uppercase decoration-dotted decoration-1 underline underline-offset-4 hover:no-underline hover:text-blue-900">
